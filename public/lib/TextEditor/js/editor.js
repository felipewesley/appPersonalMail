	...
	var methods = {
		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
							  ...
							  'styles'	: { "select":true,
											"default": "Formatação",
											"tooltip": "Formatação de parágrafo",
							 ...
							 'font_size': {	"select":true,
							  ...
							  'color'	: { "text":"A",
											"icon": "fa fa-font",
											"tooltip": "Cor do texto/preenchimento",
											"commandname":null,
						     ...
						     'ol'		: { "text": "N",
											"icon": "fa fa-list-ol",
											"tooltip": "Inserir/Remover lista ordenada",
											"commandname":"insertorderedlist",
											"custom":null },

						     'ul'		: { "text": "Bullet",
											"icon": "fa fa-list-ul",
											"tooltip": "Inserir/Remover lista não-ordenada",
						...
						'insert_table'	: { "modal": true,
						   ...
						   'indent'		: { "text": "Indent",
											"icon":"fa fa-indent",
											"tooltip": "Adicionar recuo",
											"commandname":"indent",
											"custom":null },

						   'outdent'	: { "text": "Outdent",
											"icon":"fa fa-outdent",
											"tooltip": "Remover recuo",
											"commandname":"outdent",
											"custom":null },
			...
			var menuGroups = {'texteffects' : ['bold', 'italics', 'underline', 'strikeout', 'color'],
							  ...
							  'advancedoptions' : ['print', 'rm_format', 'source'],
